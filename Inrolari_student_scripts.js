...
const url2 = "https://proba2021.lsacbucuresti.ro/my/enrolments";
const response2 = fetch(url2, {
    ...
    for (let i = 0; i < responseData2.length; i++) {
        ...
        //din varii motive js ruleaza functia deleteInregistrare la incarcarea paginii, si nu onclick
        clone.querySelector("#inscriereMeditatie").addEventListener = ("click", function() {
            const url3 = `https://proba2021.lsacbucuresti.ro/my/enrolments/${responseData2[i].id}`;
